module.exports = (app, upload) => {
  ...
  const controller = require('../controllers/admin/admin-page-controller.js')

  router.get('/page', [authJwt.verifyUserToken], controller.getPage)
  ...
  app.use('/api/admin/admin-pages', router)
}
