module.exports = (app, upload) => {
  ...
  const controller = require('../controllers/admin/admin-resource-controller.js')

  router.get('/admin-structure', [authJwt.verifyUserToken], controller.getAdminStructure)
  ...
  app.use('/api/admin/admin-resources', router)
}
